...
void DG_DrawFrame(void)
{
    ...
    /* Blob 320: 1x horizontal + vertical stretch 200->240.
       For each dest line y (0..239): src_y = y*200/240, 1:1 copy. */
    {
        u32 x;
        u32 dest_h = 240;
        for(y=0;y<dest_h;y++){
            ...
            for(x=0;x<DOOM_W;x++) d[x]=s[x];
        }
    }
    dcache_clean_range(fb, pitch*240);
