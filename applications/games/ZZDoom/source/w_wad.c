...
wad_file_t *W_AddFile (char *filename)
{
    ...
    ((volatile unsigned int*)0x04300000UL)[5]=0xC001UL;
    ...
    {
    	// WAD file
        ((volatile unsigned int*)0x04300000UL)[5]=0xC002UL;
        W_Read(wad_file, 0, &header, sizeof(header));
        ((volatile unsigned int*)0x04300000UL)[5]=0xC003UL;
		...
		((volatile unsigned int*)0x04300000UL)[5]=0xC004UL;
		((volatile unsigned int*)0x04300000UL)[14]=header.numlumps;
		((volatile unsigned int*)0x04300000UL)[15]=header.infotableofs;
		length = header.numlumps*sizeof(filelump_t);
		fileinfo = Z_Malloc(length, PU_STATIC, 0);
		((volatile unsigned int*)0x04300000UL)[5]=0xC005UL;

        W_Read(wad_file, header.infotableofs, fileinfo, length);
        ((volatile unsigned int*)0x04300000UL)[5]=0xC006UL;
