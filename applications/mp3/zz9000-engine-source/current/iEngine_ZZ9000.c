/*
 * iEngine_ZZ9000.c -- AmigaAMP external engine backend for XACP / ZZ9000.
 *
 * Original AmigaAMP EngineLibrary framework and ZZ9000 backend stub:
 *   Thomas Wenzel
 *
 * ZZ9000/XACP implementation and integration:
 *   Copyright (C) 2026 Xanxi
 *
 * SPDX-License-Identifier: LGPL-2.1-or-later
 *
 * MPEG audio decoding is performed by the XACP service on the ZZ9000 ARM.
 * The 68k-side engine implements the AmigaAMP EngineLibrary interface and
 * transfers compressed input and decoded PCM through the XACP shared-memory
 * streaming rings.
 *
 * The XACP ring layout and streaming behaviour are derived from the working
 * XACP ZZPlayGUI path.
 *
 * BUILD RULE: ASCII only. No accented characters in this source file.
 */
